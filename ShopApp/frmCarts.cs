...
namespace ShopApp
{
    public partial class frmCarts : Form
    {
        ...
        private void LoadDataGridView(string name, DataGridView table)
        {
            ...
            dgvProducts.CellFormatting -= dgvProduct_CellFormatting; // Loại bỏ đăng ký cũ nếu có để tránh đăng ký nhiều lần
            dgvProducts.CellFormatting += dgvProduct_CellFormatting;
        }
        ...
        // Chọn item khách hàng và gán sang chi tiết hóa đơn
