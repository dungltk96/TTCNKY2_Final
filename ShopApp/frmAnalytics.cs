...
namespace ShopApp
{
    public partial class frmAnalytics : Form
    {
        ...
        {
            if (dgvOrders.Columns[e.ColumnIndex].Name == "Money" && e.Value != null)
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@SearchTerm", txtSearch.Text));
