...
namespace ShopApp
{
    public partial class frmDetailOrder : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            dgvOrderProduct.CellFormatting -= dgvOrderProduct_CellFormatting; // Loại bỏ đăng ký cũ nếu có để tránh đăng ký nhiều lần
            dgvOrderProduct.CellFormatting += dgvOrderProduct_CellFormatting;
        ...
        {
            // Kiểm tra và định dạng cột Sale_price
            if (dgvOrderProduct.Columns[e.ColumnIndex].Name == "Sale_price" && e.Value != null)
            {
        ...
        // Load dữ liệu trong màn chi tiết hóa đơn
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["B10:B10"].Value = "Ngày bán:"; // Thay đổi từ "Email" thành "Ngày bán"
            exRange.Range["C10:E10"].MergeCells = true;
            exRange.Range["C10:E10"].Value = DateTime.Now.Date.ToString("dd/MM/yyyy");
            ...
            exRange.Range["A11:F11"].Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.White); // Đổi màu chữ thành màu trắng
exRange.Range["A11:F11"].Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Blue); // Đổi màu nền thành màu xanh

            /*// Thay đổi màu của tiêu đề bảng thành màu xanh
            exRange.Range["A11:F11"].Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Blue);*/

            // Tạo dòng dữ liệu cho bảng
            for (hang = 0; hang < dgvOrderProduct.RowCount; hang++)
            {
                exSheet.Cells[1][hang + 12] = hang + 1;
                for (cot = 0; cot < dgvOrderProduct.ColumnCount - 1; cot++) // Điều chỉnh số cột
                {
            ...
            exRange = exSheet.Range["A11:F" + (11 + dgvOrderProduct.RowCount)];
            exRange.Borders.LineStyle = COMExcel.XlLineStyle.xlContinuous;
            exRange.Borders.Weight = COMExcel.XlBorderWeight.xlThin;
            ...
            DateTime d = Convert.ToDateTime(DateTime.Now.Date.ToString("dd/MM/yyyy"));
